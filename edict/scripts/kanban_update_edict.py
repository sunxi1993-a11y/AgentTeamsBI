...
STATE_ORG_MAP = {
    'Taizi': '总指挥', 'Zhongshu': '总指挥', 'Menxia': '总指挥', 'Assigned': '总指挥',
    'Doing': '执行中', 'Review': '总指挥', 'Done': '完成', 'Blocked': '阻塞',
}

# State → Edict TaskState value 映射
_STATE_TO_EDICT = {
    'Taizi': 'zongzhihui', 'Zhongshu': 'canmou', 'Menxia': 'canmou',
    'Assigned': 'zongzhihui', 'Next': 'next', 'Doing': 'doing',
